...
<html>
	...
	<body>
		<form action="admin" method="post" enctype="multipart/form-data">
			...
			<input type="text" name="noOfTicketsAvailable" placeholder="Enter Total Seats In Theatre" required/><br>
			<input type="text" name="price" placeholder="Enter  Price Of Each Ticket" required/><br>
